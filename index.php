...
<body>
  ...
  <div class="interviews">
    ...
    <?php
     $sqlStatement2 = 'select departments.departmentName,interviews.role from interviews join departments on interviews.departmentCode=departments.departmentCode;';

     $queryResult = mysqli_query($dbConnection,$sqlStatement2);
     $resultcheck = mysqli_num_rows($queryResult);
